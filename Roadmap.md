...
- Requisitos: Manejo basico de una computadora y un browser
- Idioma: Ingles.
...
- Requisitos: Manejo basico de una computadora y un browser
- Idioma: Español.
- Skills: Pedir ayuda de forma efectiva en un foro
...
- Requisitos: Manejo basico de una computadora y un browser
- Idioma: Ingles.
- Skills: Conocimiento de que es una IDE, porque es importante usar una y cuales son las mas usadas.
...
- Tracking: La página cuenta con ejercicios para practicar, pero no es trackeable.
...
- Requisitos: Manejo del browser y de una computadora.
- Idioma: Ingles, subtitulos español.
- Skills: Conocimiento de JavaScript.

## Conceptos básicos de React
- [Link](https://www.coursera.org/learn/react-basics)
- Tracking: La plataforma de Coursera te muestra si completaste la lectura o el video.
- Requisitos: Manejo de HTML5, CSS3 y JavaScript.
- Idioma: Ingles, subtitulos español.
- Skills: Conocimiento básico en React JS.

## React avanzado
- [Link](https://www.coursera.org/learn/advanced-react)
- Tracking: La plataforma de Coursera te muestra si completaste la lectura o el video.
- Requisitos: Manejo de HTML5, CSS3, JavaScript y React JS básico.
- Idioma: Ingles, subtitulos español.
- Skills: Conocimiento avanzado en React JS.

## Start building with Next.js
- [Link]([https://www.coursera.org/learn/advanced-react](https://nextjs.org/learn?utm_source=next-site&utm_medium=navbar&utm_campaign=docs))
- Tracking: El web site oficial de Next JS te muestra si completaste el capitulo.
- Requisitos: Manejo de HTML5, CSS3, JavaScript y React JS avanzado.
- Idioma: Ingles.
- Skills: Conocimiento Next JS.
